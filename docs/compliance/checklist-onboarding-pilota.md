...
# Checklist za uvođenje pilot-prodavnice (F-8)

Popunjava se pre puštanja pilota u rad. Svaka stavka mora biti štiklirana i, gde je navedeno, dokumentovana pisano.

## 1. Provera ESIR-a prodavnice u Registru

Provera u [Registru odobrenih elemenata EFU](https://www.purs.gov.rs/sr/eFiskalizacija/registar-odobrenih-elemenata-efu.html):

- [ ] **Naziv** ESIR-a: `[________]`
- [ ] **Verzija**: `[________]`
- [ ] **Identifikacioni broj (IB)**: `[________]`
- [ ] **Nema rešenja o ukidanju** (element je aktivan): `[potvrđeno / datum provere]`

## 2. Pravni oblik i PDV status prodavnice
...
## 4. Brifing: korporacijska kartica / e-faktura (ZEF čl. 3)
...
- [ ] **Postavljena lozinka za šifrovanje rezervnih kopija** u VantumPOS-u.
- [ ] **Evidentirano da je lozinka sačuvana bezbedno van mašine** (npr. u menadžeru lozinki / kod vlasnika van uređaja) — bez lozinke se šifrovana kopija ne može vratiti.

---

Datum `[________]` · Prodavnica `[__________]` · Sproveo (Actaer) `[__________]`.
