...
| **Evidencija o radnom vremenu.** Mandatory (Zakon o radu + Pravilnik 120/2014), 2-year retention, inspekcija rada fines 50k–150k for a preduzetnik. You **already store the raw material** (users + shift open/close) and produce none of it. | Lowest-effort legal win on the entire list: it's a report over data that exists. | **S** |
